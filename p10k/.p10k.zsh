...
() {
  ...
  POWERLEVEL9K_KUBECONTEXT_PRD_CONTENT_EXPANSION+='${${:-/$P9K_KUBECONTEXT_NAMESPACE}:#/default}'
  ...
  POWERLEVEL9K_KUBECONTEXT_STG_CONTENT_EXPANSION+='${${:-/$P9K_KUBECONTEXT_NAMESPACE}:#/default}'
